...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Highland Garni — Triangle House Retreat" },
      {
        name: "description",
        content:
          "Explore Highland Garni rooms, gallery, amenities, reservations, and contact details from the home page.",
      },
      { property: "og:title", content: "Highland Garni — Triangle House Retreat" },
      {
        property: "og:description",
        content:
          "A mountain triangle-house retreat in Garni with gallery, amenities, reservations, and contact details.",
      },
    ],
  }),
  component: Homepage,
